...
print("[setup.py] Overload install command to enable execution of" " post install hook")
...
def main():
    setup(
        ...
        "Project website:\n"
        "https://github.com/zabbix-byte/cefpythonX",
        license="BSD 3-clause",
        author="Vasile Ovidiu Ichim",  # Real author: Czarek Tomczak
        author_email="zabbix@ztrunk.space",
...
def post_install_hook():
    ...
    # directory.
    print(
        "[setup.py] Installed package directory: {dir}".format(
            dir=installed_package_dir
        )
    )
